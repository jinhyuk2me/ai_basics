...
## 7. 더 공부하고 싶다면
- 3Blue1Brown 시리즈 (YouTube): 선형대수, 미적분, 뉴럴넷 시각화
- “Matrix Calculus for Deep Learning” (Stanford CS231n Appendix)
- Moosa, *Mathematics for Machine Learning* (Cambridge University Press)
- MIT OpenCourseWare 18.06 Linear Algebra, 18.02 Multivariable Calculus

---

## 8. 연결 노트
- [[Math/Linear Algebra/선형대수 핵심 개요]]
- [[Math/Calculus/미분과 미분법]]
- [[Operators/선형 연산자]]
- [[Operators/행렬 분해]]
