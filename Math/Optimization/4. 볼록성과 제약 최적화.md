...
### 교과서
- Boyd & Vandenberghe, *Convex Optimization* (무료 PDF)
...
Convexity와 제약 최적화를 마쳤다면:

1. **최적화 통합**
   - [[최적화 기초|최적화 기초 허브]]
   - 1차/2차 방법, convexity, SGD를 종합적으로 이해

2. **머신러닝 응용**
   - [[ML Foundations/머신러닝 최적화|ML에서의 최적화]]
   - Loss landscape, 일반화, implicit bias

3. **고급 주제**
   - [[ML Foundations/정규화와 일반화|정규화와 일반화]]
   - Flat minima, SAM, lottery ticket hypothesis

4. **다른 수학 기초**
   - [[Math/Linear Algebra/선형대수 핵심 개요|선형대수]]
   - [[Math/Calculus/미분과 미분법|미적분]]
